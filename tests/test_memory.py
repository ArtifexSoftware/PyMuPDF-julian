...
def test_4125():
    ...
    # Unfortunately on Github test machines the RSS values seem to vary a lot,
    # which causes spurious test failures. So for at least we don't actually
    # check. The underlying MuPDF bugfix was very simple so this is probably
    # ok.
    #
    if platform.system() == 'Linux':
